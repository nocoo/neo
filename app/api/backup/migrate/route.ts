 ...
 *
 * One-time migration route: reads all old D1 backups, converts each to an
 * encrypted ZIP archive (using the user's encryption key), and bundles them
 * into a single outer ZIP for download. Temporary — removed in Phase 7.
 */
...
export async function GET() {
  try {
    ...
    // Convert each backup to an encrypted ZIP
