...
export function HexlyLink() {
  return (
    <HeaderTooltip label="Neo on hexly.ai">
      <Button
        variant="ghost"
        size="icon"
      ...
      >
        <a
          href="https://hexly.ai/projects/neo"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Neo on hexly.ai (opens in a new tab)"
        >
          <span className="sr-only">Neo on hexly.ai (opens in a new tab)</span>
          <svg
            className="size-[18px]"
            width="18"
            height="18"
